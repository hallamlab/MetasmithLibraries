...
db = model.AddRequirement(lib.GetType("functional_annotation::uniref50_diamond_db"))
out_results = model.AddProduct(lib.GetType("functional_annotation::diamond_uniref50_results"))
