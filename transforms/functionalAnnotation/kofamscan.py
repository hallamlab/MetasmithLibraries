...
profiles = model.AddRequirement(lib.GetType("functional_annotation::kofamscan_profiles"))
ko_list  = model.AddRequirement(lib.GetType("functional_annotation::kofamscan_ko_list"))
out_results = model.AddProduct(lib.GetType("functional_annotation::kofamscan_results"))
