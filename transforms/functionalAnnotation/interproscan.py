...
data_dir = model.AddRequirement(lib.GetType("functional_annotation::interproscan_data"))
out_json = model.AddProduct(lib.GetType("functional_annotation::interproscan_json"))
out_gff = model.AddProduct(lib.GetType("functional_annotation::interproscan_gff"))
